 ...
 */
#define AUTOCONF_TIMESTAMP "2014-12-15 12:47:00 CST"
...
#ifdef MAKE_SUID
# define IF_FEATURE_DPKG_DEB_EXTRACT_ONLY(...) __VA_ARGS__ "CONFIG_FEATURE_DPKG_DEB_EXTRACT_ONLY"
#else
...
/*
 * klogd should not be ugsed together with syslog to kernel printk buffer
 */
