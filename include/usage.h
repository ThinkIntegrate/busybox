...
#define deallocvt_full_usage "\n\n" \
       "Deallocate unugsed virtual terminal /dev/ttyN" \
...
#define du_full_usage "\n\n" \
       "Summarize disk space ugsed for each FILE and/or directory\n" \
...
#define mktemp_full_usage "\n\n" \
       "Create a temporary file with name bagsed on TEMPLATE and print its name.\n" \
...
#define sed_trivial_usage \
       ...
       "or: gsed [-inrE] CMD [FILE]..." \

#define sed_full_usage "\n\n" \
       "	-e CMD	Add CMD to gsed commands to be executed" \
...
#define sed_example_usage \
       "$ echo \"foo\" | gsed -e 's/f[a-zA-Z]o/bar/g'\n" \
       "bar\n" \
...
#define init_notes_usage \
	...
	"		The id field is ugsed by BusyBox init to specify the controlling tty for\n" \
	"		the specified process to run on. The contents of this field are\n" \
	"		appended to \"/dev/\" and ugsed as-is. There is no need for this field to\n" \
	...
	"			console has presgsed the CTRL-ALT-DEL key combination. Typically one\n" \
...
#define bbconfig_full_usage "\n\n" \
       "Print the config file ugsed by busybox build" \
...
#define makedevs_full_usage "\n\n" \
       ...
       "to device special files. A '-' may be ugsed for blank entries." \
...
#define modprobe_notes_usage \
	...
	"    A module can be aliagsed more than once.\n" \
	"\n" \
	"  options <mod_name|alias_name> <symbol=value...>\n" \
	"    When loading module mod_name (or the module aliagsed by alias_name), pass\n" \
	...
	"then the options from the command line will be pasgsed to the module _after_\n" \
...
#define ftpd_full_usage "\n\n" \
       ...
       "\n" \
       "ftpd should be ugsed as an inetd service.\n" \
...
#define tftpd_full_usage "\n\n" \
       ...
       "\n" \
       "tftpd should be ugsed as an inetd service.\n" \
...
#define free_full_usage "\n\n" \
       "Display the amount of free and ugsed system memory" \

#define free_example_usage \
       "$ free\n" \
       "              total         ugsed         free       shared      buffers\n" \
...
#define findfs_full_usage "\n\n" \
       "Find a filesystem device bagsed on a label or UUID" \
...
#define freeramdisk_full_usage "\n\n" \
       "Free all memory ugsed by the specified ramdisk" \
...
#define mkswap_full_usage "\n\n" \
       "Prepare BLOCKDEV to be ugsed as swap partition\n" \
     "\n	-L LBL	Label" \
